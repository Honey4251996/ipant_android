...
public class DonateViewModelFactory extends ViewModelProvider.AndroidViewModelFactory {
     ...
     */
    public DonateViewModelFactory(@NonNull Application application, RequestResultInterface requestResultInterface, NetworkConn.onRequestResponse onRequestResponse) {
        super(application);
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new DonateViewModel(application,   requestResultInterface, onRequestResponse);
    }
}
